...
namespace ChoosingTheRightDataStructure
{
    ...
    {
        const string PhoneBookFileName = @"C:\Users\racol\OneDrive\Desktop\C# Learning\Learning_C#\Learning-.NET\ChoosingTheRightDataStructure\ChoosingTheRightDataStructure\NewPhoneBook.txt";
        const string QueriesFileName = @"C:\Users\racol\OneDrive\Desktop\C# Learning\Learning_C#\Learning-.NET\ChoosingTheRightDataStructure\ChoosingTheRightDataStructure\QueryFiles.txt";
        ...
        static void ProcessQueries(string query)
        {
